...
Once inside host machine 

sudo docker ps -a
sudo docker kill [container id]
sudo docker ps -a // confirm killed
sudo docker rm react-resume-container
sudo docker image ls // check image added
sudo docker run -d --name react-resume-container -p 3000:3000 react-resume // start new container
